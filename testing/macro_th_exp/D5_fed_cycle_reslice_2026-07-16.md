...
- `D5_fed_cycle_reslice_2026-07-16.csv` — slice summary
- `D5_fed_cycle_per_fire_2026-07-16.csv` — per-episode rows with fed_cycle
- `D5_fed_cycle_reslice_2026-07-16.json` — machine-readable payload
